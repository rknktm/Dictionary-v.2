...
def add():
  key = input("Write new word: ").capitalize()
  newv = input("Write antonym of the word: ").capitalize()
...
# 2-deleting word
def delete():
  key = input("Write a word to be deleted: ").capitalize()
  with open("words.txt","r",encoding = "utf-8") as file:
    dicto = dict()
    for i in file:
      pkey = str(i.strip("\n").split(" ")[0]).capitalize()
...
# 3-updating word 
def update():
  key = input("Write a word to be updated: ").capitalize()
  with open("words.txt","r",encoding = "utf-8") as file:
    dicto = dict()
    for i in file:
      pkey = str(i.strip("\n").split(" ")[0]).capitalize()  
...
# 4-finding word
def find():
  word = input("Write a word to be found: ").capitalize()
  with open("words.txt","r",encoding = "utf-8") as file:
    dicto = dict()
    for i in file:
        pkey = str(i.strip("\n").split(" ")[0]).capitalize()
